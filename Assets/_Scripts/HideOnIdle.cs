...
public class HideOnIdle : MonoBehaviour {
    ...
    void ShowButtons() {
        ...
        GameObject.FindGameObjectWithTag("backbutton").transform.localScale = new Vector3(1, 1, 1);
    }
    ...
    void HideButtons() {
        ...
        GameObject.FindGameObjectWithTag("backbutton").transform.localScale = new Vector3(0, 0, 0);
    }
